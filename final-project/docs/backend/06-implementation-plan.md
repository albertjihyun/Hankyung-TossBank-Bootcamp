...
- **(2026-07-18 구현 결정) 판매자 콜백(I-6~I-16)은 Phase 6으로 이관**: S-1~S-5와 서비스·검증을 공유하도록 명세돼 있어(04 — S-3=I-9 동일 서비스, S-5=I-11 동일 검증·로그) Phase 5에서 먼저 만들면 중복 후 재통합이 된다. Phase 5의 internal 범위는 소비자·추천 축(I-1~I-5·I-18·I-19·I-20·I-21) + I-17 스텁(501 `NOT_IMPLEMENTED`). I-13 스텁도 판매자 그룹과 함께 Phase 6으로.
