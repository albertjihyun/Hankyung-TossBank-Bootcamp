...
cart(C-1~4 — 게스트 담기 + 가입 시 병합 승계, 02 D30), orders/order_item 스냅샷 생성 + mock 결제(O-1, O-2 — 아이템 PENDING→ORDERED 전이, 01 D9), 주문 조회(O-3, O-4 가능 액션 포함), 배송 전이 + 클레임 자동 승인 스케줄러(01 §6), 클레임 신청/내역(O-5, O-6 — 취소/반품만, 01 D11), **OrderStatusChanger + order_status_logs 기록(01 D12·§6.5) + 주문 시 재고 차감(02 D33)**.
